        ...
        <div className="flex justify-between items-center">
          <div className="lg:w-3/5">
            <span className="text-base lg:text-lg">
              <CMSkeleton count={1} height={20} error={error} loading={loading} data={storeCustomizationSetting?.home?.quick_delivery_subtitle} />
            </span>
            <h2 className="font-serif text-lg lg:text-2xl font-bold mb-1">
              <CMSkeleton count={1} height={30} error={error} loading={loading} data={storeCustomizationSetting?.home?.quick_delivery_title} />
            </h2>
            <p className="text-sm font-sans leading-6">
              <CMSkeleton count={4} height={20} error={error} loading={loading} data={storeCustomizationSetting?.home?.quick_delivery_description} />
            </p>
            <Link
          ...
          <div className="w-1/5 flex-grow hidden lg:flex md:flex md:justify-items-center lg:justify-end">
            <Image
              ...
              src={getValidImagePath(storeCustomizationSetting?.home?.quick_delivery_img || "/cta/delivery-boy.png")}
            />
          </div>
        </div>
      </div>
