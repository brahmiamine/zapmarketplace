    ...
    <>
      <div className="overflow-hidden bg-white mx-auto">
        {showResetPassword ? (
          ...
          <Register setShowResetPassword={setShowResetPassword} setModalOpen={setModalOpen} />
        ) : (
          <Login setShowResetPassword={setShowResetPassword} setModalOpen={setModalOpen} />
        )}

        {storeSetting?.google_login_status && (
          <div className="my-8 after:bg-gray-100 before:bg-gray-100 fo10t-sans text-center font-medium">{t("common:or")}</div>
        )}
        ...
        <div className="text-center text-sm text-gray-900 mt-4">
          <div className="text-gray-500 mt-2.5">
            {showRegister ? t("common:Already have a account") : t("common:Not have a account")}
            <button onClick={handleModal} className="text-gray-800 hover:text-emerald-500 font-bold mx-2">
