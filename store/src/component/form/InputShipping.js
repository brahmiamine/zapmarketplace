...
const InputShipping = ({ register, value, time, cost, currency, handleShippingCost }) => {
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 font-medium">
                  ...
                  <span className="font-medium text-gray-600">
                    {showingTranslateValue(storeCustomizationSetting?.checkout?.shipping_cost)} :{currency}
                    {cost}.00
                  </span>
                </p>
              </div>
