        ...
        <div className="max-w-screen-2xl mx-auto px-3 sm:px-10">
          <div className="text-gray-700 py-2 font-sans text-xs font-medium border-b flex justify-between items-center">
            <span className="flex items-center">
              ...
              <a href={`tel:${storeCustomizationSetting?.navbar?.phone_number || "+099949343"}`} className="font-bold text-emerald-500 ml-1">
                {storeCustomizationSetting?.navbar?.phone_number || "+099949343"}
              </a>
            </span>
            ...
            <div className="lg:text-right flex items-center navBar">
              ...
              <button onClick={handleModal} className="font-medium hover:text-emerald-600">
              ...
              {userInfo?.email ? (
                ...
                <button onClick={() => setModalOpen(!modalOpen)} className="flex items-center font-medium hover:text-emerald-600">
                  <span className="mr-1">
                    <FiUser />
                  </span>
