...
import { FiGift, FiAlertCircle, FiHelpCircle, FiShoppingBag, FiFileText, FiUsers, FiPocket, FiPhoneIncoming } from "react-icons/fi";
...
const NavbarPromo = () => {
  ...
  const handleLanguage = (lang) => {
    ...
    // Reload the page with the new language code
    const currentUrl = new URL(window.location.href);
    currentUrl.pathname = `/${lang.iso_code}` + currentUrl.pathname.substring(3);
