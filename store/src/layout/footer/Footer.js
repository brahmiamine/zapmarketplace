    ...
    <div className="pb-16 lg:pb-0 xl:pb-0 bg-white">
            ...
            <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3">
              <Link href="/" className="mr-3 lg:mr-12 xl:mr-12" rel="noreferrer">
                <Image
                  width={110}
                  height={40}
                  src={getValidImagePath(storeCustomizationSetting?.footer?.block4_logo || "/logo/logo-color.svg")}
                  alt="logo"
                />
              </Link>
              <p className="leading-7 font-sans text-sm text-gray-600 mt-3">
                {showingTranslateValue(storeCustomizationSetting?.footer?.block4_address)}
                <CMSkeleton
                  count={1}
                  height={10}
                  // error={error}
              ...
              {storeCustomizationSetting?.footer?.social_links_status && (
                <div>
                  {(storeCustomizationSetting?.footer?.social_facebook ||
                    ...
                    <span className="text-base leading-7 font-medium block mb-2 pb-0.5">{t("common:footer-follow-us")}</span>
                  )}
                ...
                <ul className="lg:text-right">
                  <li className="px-1 mb-2 md:mb-0 transition hover:opacity-80 inline-flex">
                    <Image
                      ...
                      height={85}
                      className="w-full"
                      src={getValidImagePath(storeCustomizationSetting?.footer?.payment_method_img || "/payment-method/payment-logo.png")}
                      alt="payment method"
                    />
                  </li>
                </ul>
      ...
      <div className="mx-auto max-w-screen-2xl px-3 sm:px-10 flex justify-center py-4">
        <p className="text-sm text-gray-500 leading-6">
          Copyright 2023 @{" "}
          <Link href="https://www.google.com" target="_blank" rel="noopener noreferrer" className="text-emerald-500">
            Html
          </Link>
          , All rights reserved.
        </p>
