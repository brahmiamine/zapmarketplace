          ...
          <div className="grid md:grid-cols-2 gap-6 lg:grid-cols-3 xl:gap-8 font-serif">
            {loading ? (
              ...
              <div className="border p-10 rounded-lg text-center">
                ...
                <h5 className="text-xl mb-2 font-bold">{showingTranslateValue(storeCustomizationSetting?.contact_us?.email_box_title)}</h5>
                <p className="mb-0 text-base opacity-90 leading-7">
                  <a href={`mailto:${storeCustomizationSetting?.contact_us?.email_box_email}`} className="text-emerald-500">
            ...
            {loading ? (
              ...
              <div className="border p-10 rounded-lg text-center">
                ...
                <h5 className="text-xl mb-2 font-bold">{showingTranslateValue(storeCustomizationSetting?.contact_us?.call_box_title)}</h5>
                <p className="mb-0 text-base opacity-90 leading-7">
                  <a href={`mailto:${storeCustomizationSetting?.contact_us?.call_box_phone}`} className="text-emerald-500">
            ...
            {loading ? (
              ...
              <div className="border p-10 rounded-lg text-center">
                ...
                <h5 className="text-xl mb-2 font-bold">{showingTranslateValue(storeCustomizationSetting?.contact_us?.address_box_title)}</h5>
                <p className="mb-0 text-base opacity-90 leading-7">
                  <span>{showingTranslateValue(storeCustomizationSetting?.contact_us?.address_box_address_one)}</span> <br />
          ...
          <div className="px-0 pt-24 mx-auto items-center flex flex-col md:flex-row w-full justify-between">
            <div className="hidden md:w-full lg:w-5/12 lg:flex flex-col h-full">
              <Image
                width={874}
                height={874}
                src={getValidImagePath(storeCustomizationSetting?.contact_us?.midLeft_col_img || "/contact-us.png")}
                alt="logo"
