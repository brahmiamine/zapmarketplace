...
import { FiCheck, FiFileText, FiGrid, FiList, FiRefreshCw, FiSettings, FiShoppingCart, FiTruck } from "react-icons/fi";
                ...
                {!children && (
                  <div className="overflow-hidden">
                    ...
                    <div className="grid gap-4 mb-8 md:grid-cols-2 xl:grid-cols-4">
                      ...
                      />
                      <Card
                        title={showingTranslateValue(storeCustomizationSetting?.dashboard?.paid_order)}
                        Icon={FiTruck}
                        quantity={data?.paid}
