...
const forgetPassword = async (req, res) => {
  ...
  if (!isAdded) {
    ...
    const body = {
      ...
      <p>A request has been received to change the password for your <strong>ZAPMarketplace</strong> account </p>
        ...
        <p style="margin-top: 35px;">If you did not initiate this request, please contact us immediately at support@zapmarketplace.com</p>

        <p style="margin-bottom:0px;">Thank you</p>
        <strong>ZAPMarketplace Team</strong>
             `,
    };
  ...
  try {
    ...
    if (isAdded) {
      ...
      const newStaff = new Admin({
        ...
        ...(req.body.permissions && req.body.permissions.length > 0 ? { permissions: req.body.permissions } : {}),
