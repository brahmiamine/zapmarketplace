    ...
    const globalSetting = await Setting.updateOne(
      ...
      },
      {
        $set: {
          ...
          "setting.google_analytic_status": req.body.setting.google_analytic_status,
          ...
          "setting.tawk_chat_property_id": req.body.setting.tawk_chat_property_id,
          "setting.tawk_chat_widget_id": req.body.setting.tawk_chat_widget_id,
          "setting.external_integration_status": req.body.setting.external_integration_status,
          "setting.external_integration_api": req.body.setting.external_integration_api,
          // //for seo
  ...
  try {
    ...
    const storeCustomizationSetting = await Setting.findOneAndUpdate(
      ...
      },
      {
        $set: {
          // navbar
          "setting.navbar.nav_color": setting.navbar.nav_color,
          ...
          "setting.navbar.term_and_condition": setting.navbar.term_and_condition,
          ...
          "setting.navbar.term_and_condition_status": setting.navbar.term_and_condition_status,
          "setting.navbar.privacy_policy_status": setting.navbar.privacy_policy_status,
          "setting.navbar.faq_status": setting.navbar.faq_status,
          "setting.navbar.categories_menu_status": setting.navbar.categories_menu_status,
          "setting.navbar.about_menu_status": setting.navbar.about_menu_status,
          "setting.navbar.contact_menu_status": setting.navbar.contact_menu_status,
          "setting.navbar.offers_menu_status": setting.navbar.offers_menu_status,
          ...
          "setting.home.feature_promo_status": setting.home.feature_promo_status,

          "setting.home.slider_width_status": setting.home.slider_width_status,
          "setting.home.promotion_banner_status": setting.home.promotion_banner_status,
          "setting.home.delivery_status": setting.home.delivery_status,
          "setting.home.popular_products_status": setting.home.popular_products_status,
          "setting.home.discount_product_status": setting.home.discount_product_status,
          "setting.home.discount_coupon_code": setting.home.discount_coupon_code,
          ...
          "setting.home.promotion_description": setting.home.promotion_description,
          "setting.home.promotion_button_name": setting.home.promotion_button_name,
          "setting.home.promotion_button_link": setting.home.promotion_button_link,
          "setting.home.feature_title": setting.home.feature_title,
          "setting.home.feature_description": setting.home.feature_description,
          "setting.home.feature_product_limit": setting.home.feature_product_limit,
          "setting.home.popular_title": setting.home.popular_title,
          "setting.home.popular_description": setting.home.popular_description,
          "setting.home.popular_product_limit": setting.home.popular_product_limit,
          "setting.home.quick_delivery_subtitle": setting.home.quick_delivery_subtitle,
          "setting.home.quick_delivery_title": setting.home.quick_delivery_title,
          "setting.home.quick_delivery_description": setting.home.quick_delivery_description,
          "setting.home.quick_delivery_button": setting.home.quick_delivery_button,
          ...
          "setting.home.latest_discount_title": setting.home.latest_discount_title,
          "setting.home.latest_discount_description": setting.home.latest_discount_description,
          "setting.home.latest_discount_product_limit": setting.home.latest_discount_product_limit,
          "setting.home.daily_need_title": setting.home.daily_need_title,
          "setting.home.daily_need_description": setting.home.daily_need_description,
          "setting.home.daily_need_app_link": setting.home.daily_need_app_link,
          "setting.home.daily_need_google_link": setting.home.daily_need_google_link,
          "setting.home.daily_need_img_left": setting.home.daily_need_img_left,
          "setting.home.daily_need_img_right": setting.home.daily_need_img_right,
          ...
          "setting.slider.second_description": setting.slider.second_description,
          ...
          //checkout
          "setting.checkout.personal_details": setting.checkout.personal_details,
          ...
          "setting.checkout.shipping_details": setting.checkout.shipping_details,
          ...
          //dashboard
          "setting.dashboard.invoice_message_first": setting.dashboard.invoice_message_first,
          "setting.dashboard.invoice_message_last": setting.dashboard.invoice_message_last,
          "setting.dashboard.print_button": setting.dashboard.print_button,
          "setting.dashboard.download_button": setting.dashboard.download_button,
          "setting.dashboard.dashboard_title": setting.dashboard.dashboard_title,
          ...
          "setting.dashboard.paid_order": setting.dashboard.paid_order,
          "setting.dashboard.processing_order": setting.dashboard.processing_order,
          ...
          "setting.dashboard.current_password": setting.dashboard.current_password,
          "setting.dashboard.new_password": setting.dashboard.new_password,
          "setting.dashboard.change_password": setting.dashboard.change_password,

          // about us
          "setting.about_us.header_status": setting.about_us.header_status,
          "setting.about_us.content_left_status": setting.about_us.content_left_status,
          "setting.about_us.content_right_status": setting.about_us.content_right_status,
          "setting.about_us.content_middle_status": setting.about_us.content_middle_status,
          "setting.about_us.content_middle_status": setting.about_us.content_middle_status,
          "setting.about_us.header_bg": setting.about_us.header_bg,
          "setting.about_us.content_right_img": setting.about_us.content_right_img,
          "setting.about_us.content_middle_Img": setting.about_us.content_middle_Img,
          ...
          "setting.about_us.founder_three_img": setting.about_us.founder_three_img,
          "setting.about_us.founder_four_img": setting.about_us.founder_four_img,
          "setting.about_us.founder_five_img": setting.about_us.founder_five_img,
          ...
          "setting.about_us.card_one_description": setting.about_us.card_one_description,
          ...
          "setting.about_us.card_two_description": setting.about_us.card_two_description,
          "setting.about_us.middle_description_one": setting.about_us.middle_description_one,
          "setting.about_us.middle_description_two": setting.about_us.middle_description_two,
          "setting.about_us.founder_title": setting.about_us.founder_title,
          "setting.about_us.founder_description": setting.about_us.founder_description,
          "setting.about_us.founder_one_name": setting.about_us.founder_one_name,
          "setting.about_us.founder_one_sub": setting.about_us.founder_one_sub,
          "setting.about_us.founder_two_name": setting.about_us.founder_two_name,
          "setting.about_us.founder_two_sub": setting.about_us.founder_two_name,
          "setting.about_us.founder_three_name": setting.about_us.founder_three_name,
          "setting.about_us.founder_three_sub": setting.about_us.founder_three_sub,
          "setting.about_us.founder_four_name": setting.about_us.founder_four_name,
          "setting.about_us.founder_four_sub": setting.about_us.founder_four_sub,
          "setting.about_us.founder_five_name": setting.about_us.founder_five_name,
          "setting.about_us.founder_five_sub": setting.about_us.founder_five_sub,
          "setting.about_us.founder_six_name": setting.about_us.founder_six_name,
          ...
          "setting.contact_us.email_box_status": setting.contact_us.email_box_status,
          "setting.contact_us.call_box_status": setting.contact_us.call_box_status,
          "setting.contact_us.address_box_status": setting.contact_us.address_box_status,
          "setting.contact_us.left_col_status": setting.contact_us.left_col_status,
          ...
          "setting.contact_us.email_box_title": setting.contact_us.email_box_title,
          "setting.contact_us.email_box_email": setting.contact_us.email_box_email,
          "setting.contact_us.email_box_text": setting.contact_us.email_box_text,
          "setting.contact_us.call_box_title": setting.contact_us.call_box_title,
          "setting.contact_us.call_box_phone": setting.contact_us.call_box_phone,
          "setting.contact_us.call_box_text": setting.contact_us.call_box_text,
          "setting.contact_us.address_box_title": setting.contact_us.address_box_title,
          "setting.contact_us.address_box_address_one": setting.contact_us.address_box_address_one,
          "setting.contact_us.address_box_address_two": setting.contact_us.address_box_address_two,
          "setting.contact_us.address_box_address_three": setting.contact_us.address_box_address_three,
          "setting.contact_us.form_title": setting.contact_us.form_title,
          "setting.contact_us.form_description": setting.contact_us.form_description,
          ...
          "setting.privacy_policy.description": setting.privacy_policy.description,

          //terms and condition
          "setting.term_and_condition.status": setting.term_and_condition.status,
          "setting.term_and_condition.header_bg": setting.term_and_condition.header_bg,
          "setting.term_and_condition.title": setting.term_and_condition.title,
          "setting.term_and_condition.description": setting.term_and_condition.description,
          ...
          "setting.footer.payment_method_status": setting.footer.payment_method_status,
          "setting.footer.bottom_contact_status": setting.footer.bottom_contact_status,
          "setting.footer.social_links_status": setting.footer.social_links_status,
          ...
          "setting.footer.payment_method_img": setting.footer.payment_method_img,
          "setting.footer.bottom_contact": setting.footer.bottom_contact,

          // slug page
          "setting.slug.right_box_status": setting.slug.right_box_status,
          "setting.slug.card_description_one": setting.slug.card_description_one,
          "setting.slug.card_description_two": setting.slug.card_description_two,
          "setting.slug.card_description_three": setting.slug.card_description_three,
          "setting.slug.card_description_four": setting.slug.card_description_four,
          "setting.slug.card_description_five": setting.slug.card_description_five,
          "setting.slug.card_description_six": setting.slug.card_description_six,
          "setting.slug.card_description_seven": setting.slug.card_description_seven,
