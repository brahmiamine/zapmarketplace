...
const StaffOrder = () => {
  ...
  const { data, loading, error } = useAsync(() => OrderServices.getOrderStaff(id));
  console.log(data);
  ...
  return (
    <>
      <PageTitle>{t("List Staff Commande")}</PageTitle>
          ...
          <Table>
            <TableHeader>
              <tr>
                ...
                <TableCell className="text-center"> {t("CustomerOrderStatus")} </TableCell>
                <TableCell className="text-center">{t("CustomerOrderAction")}</TableCell>
              </tr>
            </TableHeader>
