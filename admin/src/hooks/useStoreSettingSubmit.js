...
const useStoreSettingSubmit = (id) => {
  ...
  const [enabledExternalIntegration, setEnabledExternalIntegration] = useState(true);
    ...
    try {
      ...
      const settingData = {
        ...
        setting: {
          ...
          external_integration_status: enabledExternalIntegration,
          external_integration_api: data.external_integration_api,
        },
      };
    ...
    (async () => {
      try {
        ...
        if (res) {
          ...
          setEnabledExternalIntegration(res.external_integration_status);
          ...
          setValue("external_integration_api", res.external_integration_api);
        }
      } catch (err) {
        notifyError(err?.response?.data?.message || err.message);
      }
