        ...
        setting: {
          ...
          term_and_condition: {
            ...
            description: {
              ...
              [language]: termsConditionsTextEdit ? draftToHtml(convertToRaw(termsConditionsTextEdit.getCurrentContent())) : "",
            },
          },
          faq: {
          ...
          dashboard: {
            ...
            paid_order: {
              ...resData?.dashboard?.paid_order,
              [language]: data.paid_order || "",
            },
    ...
    const getStoreCustomizationData = async () => {
      try {
        ...
        if (res) {
          ...
          //navbar
          setNavColor(res?.navbar?.nav_color);
          ...
          setValue("nav_color", res?.navbar?.nav_color);
          ...
          setValue("paid_order", res?.dashboard?.paid_order[language || "en"]);
