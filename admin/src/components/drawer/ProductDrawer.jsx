    ...
    <>
      ...
      <div className="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-700">
        ...
        <ul className="flex flex-wrap -mb-px">
          <li className="mr-2">
            <ActiveButton tapValue={tapValue} activeValue="Basic Info" handleProductTap={handleProductTap} />
          </li>

          {isCombination && (
            <li className="mr-2">
              <ActiveButton tapValue={tapValue} activeValue="Combination" handleProductTap={handleProductTap} />
            </li>
          )}
        </ul>
      </div>
          ...
          {tapValue === "Basic Info" && (
            <div className="px-6 pt-8 flex-grow w-full h-full max-h-full pb-40 md:pb-32 lg:pb-32 xl:pb-32">
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                ...
                <div className="col-span-8 sm:col-span-4">
                  <InputArea register={register} required="false" label={t("ProductSKU")} name="sku" type="text" placeholder={t("ProductSKU")} />
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6 relative">
                <LabelArea label={t("minimum product sale")} />
                <div className="col-span-8 sm:col-span-4">
                  <InputValueFive
                    disabled={isCombination}
                    register={register}
                    ...
                    name="min"
                    type="number"
                    placeholder={t("minimum product sale")}
                  />
                  <Error errorName={errors.stock} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                ...
                <div className="col-span-8 sm:col-span-4">
                  <ReactTagInput placeholder={t("ProductTagPlaseholder")} tags={tag} onChange={(newTags) => setTag(newTags)} />
                </div>
              </div>
            </div>
          )}
