...
const DrawerButtonDelivery = ({ id, title, isSubmitting, name, days, cost }) => {
  const { t } = useTranslation();
  const { toggleDrawer, isDrawerOpen, closeDrawer, setIsUpdate } = useContext(SidebarContext);

  const handleSubmit = async () => {
    const res = await DeliveryServices.addDelivery({ name, days, cost });
    console.log(res);
    setIsUpdate(true);
...
export default DrawerButtonDelivery;
