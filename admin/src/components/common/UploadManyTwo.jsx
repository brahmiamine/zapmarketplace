...
const UploadManyTwo = ({ title, totalDoc, exportData, isDisabled, handleSelectFile, filename, handleRemoveSelectFile, handleUploadMultiple }) => {
    ...
    <div className=" lg:flex md:flex flex-grow-0">
      <div className="flex">
        <div ref={dRef} className="lg:flex-1 md:flex-1 mr-3 sm:flex-none">
          ...
          {dropDown && (
            <ul className="origin-top-left absolute  w-56 rounded-md shadow-lg bg-white dark:bg-gray-800 focus:outline-none z-40" style={{}}>
            ...
            <div className="h-10 border border-dashed border-emerald-500 rounded-md">
              <label className="w-full rounded-lg h-10 flex justify-center items-center text-xs dark:text-gray-400 leading-none">
                ...
                {filename ? (
                  ...
                  <>
                    <FiUploadCloud className="mx-2 text-emerald-500 text-lg dark:text-gray-400" /> {t("SelectYourJSON")} {title} {t("File")}
                  </>
                )}
                {filename && (
                  <span onClick={handleRemoveSelectFile} type="button" className="text-red-500 focus:outline-none mx-4 text-lg">
                    <FiXCircle />
                  </span>
                )}
              </label>
            ...
            <div className="flex">
              {loading ? (
                <Button className="ml-2 h-10">
                  <img src={getValidImagePath(spinnerLoadingImage)} alt="Loading" width={20} height={10} />{" "}
