    ...
    <>
      <div className="grid grid-cols-12 font-sans pr-4">
          ...
          <div className="flex-grow scrollbar-hide w-full max-h-full xl:px-10">
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
              ...
              <div className="sm:col-span-4">
                <InputAreaTwo required register={register} label={t("HeaderText")} name="help_text" type="text" placeholder={t("weAreAvailable")} />
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
              ...
              <div className="sm:col-span-4">
                <InputAreaTwo required register={register} label={t("PhoneNumber")} name="phone_number" type="text" placeholder="+01234560352" />
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
              ...
              <div className="sm:col-span-4">
                <InputAreaTwo required register={register} label={t("Color")} name="nav_color" type="color" />
            ...
            <div className="sm:col-span-4 md:pl-3 sm:pl-2">
              ...
              <div className="grid grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                <div className="col-span-4">
                  ...
                  <InputAreaTwo required register={register} label={t("Categories")} name="categories" type="text" placeholder={t("Categories")} />
                ...
                <div className="col-span-4">
                  ...
                  <InputAreaTwo required register={register} label={t("AboutUs")} name="about_us" type="text" placeholder={t("AboutUs")} />
                ...
                <div className="col-span-4">
                  ...
                  <InputAreaTwo required register={register} label={t("ContactUs")} name="contact_us" type="text" placeholder={t("ContactUs")} />
                ...
                <div className="col-span-4">
                  ...
                  <InputAreaTwo required register={register} label={t("Offers")} name="offers" type="text" placeholder={t("Offers")} />
                ...
                <div className="col-span-4">
                  ...
                  <InputAreaTwo required register={register} label={t("FAQ")} name="faq" type="text" placeholder={t("FAQ")} />
                ...
                <div className="col-span-4">
                  ...
                  <InputAreaTwo required register={register} label={t("Pages")} name="pages" type="text" placeholder={t("Pages")} />
                ...
                <div className="col-span-4">
                  ...
                  <InputAreaTwo required register={register} label={t("MyAccount")} name="my_account" type="text" placeholder={t("MyAccount")} />
                ...
                <div className="col-span-4">
                  ...
                  <InputAreaTwo required register={register} label={t("Login")} name="login" type="text" placeholder={t("Login")} />
                ...
                <div className="col-span-4">
                  ...
                  <InputAreaTwo required register={register} label={t("Logout")} name="logout" type="text" placeholder={t("Logout")} />
                ...
                <div className="col-span-4">
                  ...
                  <InputAreaTwo required register={register} label={t("CheckOut")} name="checkout" type="text" placeholder={t("CheckOut")} />
              ...
              <div className="grid xl:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                <div>
                  <h4 className="font-medium font-serif md:text-base text-sm mb-2 dark:text-gray-300">{t("Categories")}</h4>

                  <SwitchToggle title={""} handleProcess={setCategoriesMenuLink} processOption={categoriesMenuLink} />
                </div>
                <div>
                  <h4 className="font-medium font-serif md:text-base text-sm mb-2 dark:text-gray-300">{t("AboutUs")}</h4>

                  <SwitchToggle title={""} handleProcess={setAboutUsMenuLink} processOption={aboutUsMenuLink} />
                </div>
                <div>
                  <h4 className="font-medium font-serif md:text-base text-sm mb-2 dark:text-gray-300">{t("ContactUs")}</h4>

                  <SwitchToggle title={""} handleProcess={setContactUsMenuLink} processOption={contactUsMenuLink} />
                </div>
                <div>
                  <h4 className="font-medium font-serif md:text-base text-sm mb-2 dark:text-gray-300">{t("Offers")}</h4>

                  <SwitchToggle title={""} handleProcess={setOffersMenuLink} processOption={offersMenuLink} />
                </div>
                <div>
                  <h4 className="font-medium font-serif md:text-base text-sm mb-2 dark:text-gray-300">{t("FAQ")}</h4>

                  <SwitchToggle title={""} handleProcess={setFaqMenuLink} processOption={faqMenuLink} />
                </div>
                <div>
                  <h4 className="font-medium font-serif md:text-base text-sm mb-2 dark:text-gray-300">{t("PrivacyPolicy")}</h4>

                  <SwitchToggle title={""} handleProcess={setPrivacyPolicyMenuLink} processOption={privacyPolicyMenuLink} />
                </div>
                <div>
                  <h4 className="font-medium font-serif md:text-base text-sm mb-2 dark:text-gray-300">{t("TermsConditions")}</h4>

                  <SwitchToggle title={""} handleProcess={setTermsConditionsMenuLink} processOption={termsConditionsMenuLink} />
                </div>
              </div>
            </div>
          </div>
              ...
              <Tabs>
                ...
                <TabPanel className="md:mt-10 mt-3">
                  <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                    ...
                    <div className="sm:col-span-4">
                      <Uploader imageUrl={sliderImage} setImageUrl={setSliderImage} />
                    </div>
                  </div>
                ...
                <TabPanel>
                  <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                    ...
                    <div className="sm:col-span-4">
                      <Uploader imageUrl={sliderImageTwo} setImageUrl={setSliderImageTwo} />
                    </div>
                  </div>
                ...
                <TabPanel>
                  <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                    ...
                    <div className="sm:col-span-4">
                      <Uploader imageUrl={sliderImageThree} setImageUrl={setSliderImageThree} />
                    </div>
                  </div>
                ...
                <TabPanel>
                  <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                    ...
                    <div className="sm:col-span-4">
                      <Uploader imageUrl={sliderImageFour} setImageUrl={setSliderImageFour} />
                    </div>
                  </div>
                ...
                <TabPanel>
                  <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                    ...
                    <div className="sm:col-span-4">
                      <Uploader imageUrl={sliderImageFive} setImageUrl={setSliderImageFive} />
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-3 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                    <div>
                      <div className="relative">
                        <h4 className="font-medium md:text-base text-sm mb-2 dark:text-gray-400"> {t("LeftRighArrows")}</h4>
                      </div>
                      <SwitchToggle title={""} handleProcess={setLeftRightArrow} processOption={leftRightArrow} />
                    </div>
                    <div>
                      <div className="relative">
                        <h4 className="font-medium md:text-base text-sm mb-2 dark:text-gray-400">{t("BottomDots")}</h4>
                      </div>
                      <SwitchToggle title={""} handleProcess={setBottomDots} processOption={bottomDots} />
                    </div>
                    <div>
                      <div className="relative">
                        <h4 className="font-medium md:text-base text-sm mb-2 dark:text-gray-400">{t("Both")}</h4>
                      </div>
            ...
            >
              <div>
                ...
                <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 ">
                  ...
                  <div className="sm:col-span-4 ">
                    <SwitchToggle title="" handleProcess={setIsSliderFullWidth} processOption={isSliderFullWidth} name={isSliderFullWidth} />
                  </div>
                </div>
              </div>
        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12">
          ...
          <div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full pb-0">
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setAllowPromotionBanner} processOption={allowPromotionBanner} name={allowPromotionBanner} />
              </div>
            </div>
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="promotion_title" type="text" placeholder={t("Title")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo
                    ...
                    type="text"
                    placeholder="https://store.zapmarketplace.online/search?category=fruits-vegetable&_id=632aca2b4d87ff2494210be8"
                  />
        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12 md:mt-0 mt-15">
          ...
          <div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full pb-0">
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setFeaturedCategories} processOption={featuredCategories} name={featuredCategories} />
              </div>
            </div>
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="feature_title" type="text" placeholder={t("Title")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <SelectProductLimit required register={register} label="Feature Products Limit" name="feature_product_limit" />
        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12 md:mt-0 mt-15">
          ...
          <div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full pb-0">
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setPopularProducts} processOption={popularProducts} name={popularProducts} />
              </div>
            </div>
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="popular_title" type="text" placeholder={t("Title")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <SelectProductLimit required register={register} label="Popular Products Limit" name="popular_product_limit" />
        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12 mt-15">
          ...
          <div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full pb-0">
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title={""} handleProcess={setQuickDelivery} processOption={quickDelivery} name={quickDelivery} />
              </div>
            </div>
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="quick_delivery_subtitle" type="text" placeholder={t("SubTitle")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="quick_delivery_title" type="text" placeholder={t("Title")} />
        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12 md:mt-0 mt-10">
          <div className="inline-flex md:text-lg text-base text-gray-800 font-semibold dark:text-gray-400 mb-3">
            <FiSettings className="mt-1 mr-2" /> {t("LatestDiscountedProductsTitle")}
          </div>
          ...
          <div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full pb-0">
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setLatestDiscounted} processOption={latestDiscounted} name={latestDiscounted} />
              </div>
            </div>
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="latest_discount_title" type="text" placeholder={t("Title")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <SelectProductLimit required register={register} label="Latest Discount Products Limit" name="latest_discount_product_limit" />
        ...
        <div className={`col-span-12 md:col-span-12 lg:col-span-12 ${window.innerWidth < 400 ? "md:my-0 my-24" : "md:my-0 my-24"}`}>
          <div className="inline-flex md:text-lg text-base text-gray-800 font-semibold dark:text-gray-400 mb-3">
          ...
          <div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full pb-0">
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="daily_need_title" type="text" placeholder={t("Title")} />
        ...
        <div className={`col-span-12 md:col-span-12 lg:col-span-12 ${window.innerWidth < 400 ? "md:mt-0 mt-40" : "md:mt-0 mt-10"}`}>
          <div className="inline-flex md:text-lg text-base text-gray-800 font-semibold dark:text-gray-400 mb-3">
          ...
          <div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full pb-0">
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setFeaturePromo} processOption={featurePromo} name={featurePromo} />
              </div>
            </div>
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="promo_free_shipping" type="text" placeholder="From $500.00" />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="promo_support" type="text" placeholder="24/7 At Anytime" />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="promo_payment" type="text" placeholder={t("SecurePayment")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="promo_offer" type="text" placeholder="Upto 20% Off" />
        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12 md:mt-0 mt-10">
          ...
          <div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full pb-0">
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setFooterBlock1} processOption={footerBlock1} name={footerBlock1} />
              </div>
            </div>
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-4">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_one_title" type="text" placeholder="Company" />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <div className="sm:col-span-4 mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_one_link_one" type="text" placeholder={t("Link")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4  mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_one_link_two" type="text" placeholder={t("Link")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4  mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_one_link_three" type="text" placeholder={t("Link")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4 mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_one_link_four" type="text" placeholder={t("Link")} />
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setFooterBlock2} processOption={footerBlock2} name={footerBlock2} />
              </div>
            </div>
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_two_title" type="text" placeholder={t("TopCategory")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4  mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_two_link_one" type="text" placeholder={t("Link")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4  mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_two_link_two" type="text" placeholder={t("Link")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4  mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_two_link_three" type="text" placeholder={t("Link")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4  mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_two_link_four" type="text" placeholder={t("Link")} />
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setFooterBlock3} processOption={footerBlock3} name={footerBlock3} />
              </div>
            </div>
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_three_title" type="text" placeholder="My Account" />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4  mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_three_link_one" type="text" placeholder={t("Link")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4  mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_three_link_two" type="text" placeholder={t("Link")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4  mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_three_link_three" type="text" placeholder={t("Link")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-1">
                ...
                <label className="md:col-span-1 sm:col-span-2"></label>
                <div className="sm:col-span-4  mb-5">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_three_link_four" type="text" placeholder={t("Link")} />
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setFooterBlock4} processOption={footerBlock4} name={footerBlock4} />
              </div>
            </div>
            ...
            >
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_four_address" type="text" placeholder="Address" />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_four_phone" type="text" placeholder={t("Phone")} />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="footer_block_four_email" type="text" placeholder="Email" />
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setFooterSocialLinks} processOption={footerSocialLinks} name={footerSocialLinks} />
              </div>
            </div>
            ...
            >
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="social_facebook" type="text" placeholder="Facebook link" />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="social_twitter" type="text" placeholder="Twitter Link" />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="social_pinterest" type="text" placeholder="Pinterest Link" />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="social_linkedin" type="text" placeholder="Linkedin Link" />
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo required register={register} label="Title" name="social_whatsapp" type="text" placeholder="whatsApp Link" />
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setFooterPaymentMethod} processOption={footerPaymentMethod} name={footerPaymentMethod} />
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3">
              ...
              <div className="sm:col-span-4">
                <SwitchToggle title="" handleProcess={setFooterBottomContact} processOption={footerBottomContact} name={footerBottomContact} />
              </div>
            </div>
